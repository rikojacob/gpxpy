...
##        self.assertTrue(make_str(security) == 'Open')
            ...
            # def test_nearest(gpx_part: Union[mod_gpx.GPX, mod_gpx.GPXTrack, mod_gpx.GPXTrackSegment],loc) -> mod_gpx.NearestLocationData:

            # nearest_loc_info =test_nearest( gpx, loc)
